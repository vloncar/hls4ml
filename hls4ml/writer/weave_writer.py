...
class WeaveWriter(Writer):
    ...
    def write_project_cpp(self, model):
        ...
        f = open(os.path.join(filedir, '../templates/weave/firmware/myproject.cpp'))
    ...
    def write_project_header(self, model):
        ...
        filedir = os.path.dirname(os.path.abspath(__file__))
        f = open(os.path.join(filedir, '../templates/weave/firmware/myproject.h'))
    ...
    def write_defines(self, model):
        ...
        """
        filedir = os.path.dirname(os.path.abspath(__file__))
        f = open(os.path.join(filedir, '../templates/weave/firmware/defines.h'))
    ...
    def write_parameters(self, model):
        ...
        """
        filedir = os.path.dirname(os.path.abspath(__file__))
        f = open(os.path.join(filedir, '../templates/weave/firmware/parameters.h'))
    ...
    def write_test_bench(self, model):
        ...
        f = open(os.path.join(filedir, '../templates/weave/myproject_test.cpp'))
    ...
    def write_bridge(self, model):
        ...
        filedir = os.path.dirname(os.path.abspath(__file__))
        f = open(os.path.join(filedir, '../templates/weave/myproject_bridge.cpp'))
    ...
    def write_build_script(self, model):
        """Write the TCL/Shell build scripts (project.tcl, build_prj.tcl, build_opt.tcl, build_lib.sh)
        ...
        # build_prj.tcl (+ build_opt.tcl, sourced by it and (re)written by WeaveBackend.build())
        srcpath = (filedir / '../templates/weave/build_prj.tcl').resolve()
        dstpath = f'{model.config.get_output_dir()}/build_prj.tcl'
        copyfile(srcpath, dstpath)
        copyfile((filedir / '../templates/weave/build_opt.tcl').resolve(), f'{model.config.get_output_dir()}/build_opt.tcl')

        # build_lib.sh
        build_lib_src = (filedir / '../templates/weave/build_lib.sh').resolve()
    ...
    def write_nnet_utils(self, model):
        ...
        srcpath = os.path.join(filedir, '../templates/weave/nnet_utils/')
        ...
        srcpath = os.path.join(filedir, '../templates/weave/ap_types/')
