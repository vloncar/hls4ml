...
#ifndef NAME
    #define NAME "HSoftmax"
#endif

class HSoftmaxOp : public OpKernel {
    public:
        ...
        void Compute(OpKernelContext* context) override {
            ...
            for (int b = 0; b < n_batch; b++) {
                ...
                nnet::softmax<input_t, result_t, hconfig>(ap_data, ap_res);
...
REGISTER_KERNEL_BUILDER(Name(NAME).Device(DEVICE_CPU), HSoftmaxOp);
