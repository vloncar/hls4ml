...
void merge_bcast(data_T data[CONFIG_T::n_elem1_0 * CONFIG_T::n_elem1_1 * CONFIG_T::n_elem1_2],
                 res_T res[CONFIG_T::n_elem2_0 * CONFIG_T::n_elem2_1 * CONFIG_T::n_elem2_2]) {
    #pragma HLS PIPELINE
    ...
    for (int ii = 0; ii < CONFIG_T::n_elem2_0; ii++) {
        for (int jj = 0; jj < CONFIG_T::n_elem2_1; jj++) {
            for (int kk = 0; kk < CONFIG_T::n_elem2_2; kk++) {
                int data_idx;
                if (CONFIG_T::axis == 2) {
                    data_idx = ii * CONFIG_T::n_elem2_1 + jj;
                } else if (CONFIG_T::axis == 1) {
                    data_idx = ii * CONFIG_T::n_elem2_2 + kk;
                } else { // axis == 0
                    data_idx = jj * CONFIG_T::n_elem2_2 + kk;
                }
                res[ii * CONFIG_T::n_elem2_1 * CONFIG_T::n_elem2_2 + jj * CONFIG_T::n_elem2_2 + kk] = data[data_idx];
            }
        }
    }
}
