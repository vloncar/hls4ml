...
custom_layers_cpp_files = []

def register_cpp_file(filename, export_path='nnet_utils'):
    global custom_layers_cpp_files
    custom_layers_cpp_files.append({'file':filename, 'path':export_path})
